...
import dev.suncat.mod.modules.impl.client.hud.TextRadar;
...
extends Module {
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        for (PlayerEntity playerEntity : suncat.THREAD.getPlayers()) {
...
info.append(" ");
    ...
    private int getNametagColor(PlayerEntity player) {
        if (this.friendConfig.booleanValue && player.getDisplayName() != null && suncat.FRIEND.isFriend(player)) {
