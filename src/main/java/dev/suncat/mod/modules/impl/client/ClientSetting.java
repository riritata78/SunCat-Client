...
extends Module {
    ...
    public final BooleanSetting loadingImage = this.add(new BooleanSetting("LoadingImage", true, () -> this.page.is(Page.Gui)));
    public final EnumSetting<LoadingMode> loadingImageMode = this.add(new EnumSetting<LoadingMode>("LoadingImageMode", LoadingMode.Single, () -> this.page.is(Page.Gui) && this.loadingImage.isOpen()));
    ...
    public final StringSetting windowTitle = this.add(new StringSetting("WindowTitle", dev.suncat.suncat.NAME, () -> this.page.is(Page.Misc) && this.titleOverride.isOpen()));
    ...
    public final StringSetting hackName = this.add(new StringSetting("Notification", "[" + dev.suncat.suncat.NAME + "]", () -> this.page.getValue() == Page.Notification));
